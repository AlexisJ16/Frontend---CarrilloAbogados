  ...
  return (
    <div className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-40 flex flex-col gap-3">
      <motion.a
        ...
        className="p-3.5 sm:p-4 rounded-full bg-[#25D366] text-white shadow-[0_0_20px_rgba(37,211,102,0.3)] hover:scale-110 transition-transform duration-200 group"
      ...
      <motion.a
        ...
        className="p-3.5 sm:p-4 rounded-full bg-white text-black shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:scale-110 transition-transform duration-200 group"
